  ...
  async function handleSubmit(
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data?.error ||
            "The guarantee could not be emailed."
        );
      }
            ...
            {loading ? (
              ...
              >
                <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <div>
                    <label
                      htmlFor={`guarantee-email-to-${guaranteeId}`}
                  ...
                  <div className="mt-5">
                    <label
                      htmlFor={`guarantee-email-subject-${guaranteeId}`}
                      className="block text-sm font-semibold text-slate-700"
                    >
                      Subject
                    </label>
                  ...
                  <div className="mt-5">
                    <div className="flex items-center justify-between gap-4">
                      <label
                        htmlFor={`guarantee-email-body-${guaranteeId}`}
                        className="block text-sm font-semibold text-slate-700"
                      >
                        Email Message
                      </label>
                    ...
                    <div className="mt-2 rounded-lg bg-slate-50 px-4 py-3 text-xs leading-5 text-slate-500">
                      ...
                      button and guarantee summary are added automatically.
                    </div>
                  </div>
                  ...
                  <div className="mt-6 border-t border-slate-200 pt-6">
                    ...
                    <div className="mt-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                      ...
                      <p className="mt-1 text-xs leading-5 text-emerald-700">
                        The secure View Guarantee button is automatically included in the email.
                      </p>
                    </div>
                ...
                <div className="flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 bg-slate-50 px-6 py-4">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-emerald-700 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-800 disabled:cursor-not-allowed disabled:bg-slate-400"
                  >
                    {sending
                      ? "Sending..."
                      : "Send Guarantee"}
