            ...
            {loading ? (
              ...
              >
                <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <div>
                    <label
                      htmlFor={`invoice-email-to-${invoiceId}`}
                  ...
                  <div className="mt-5">
                    <label
                      htmlFor={`invoice-email-subject-${invoiceId}`}
                      className="block text-sm font-semibold text-slate-700"
                    >
                      Subject
                    </label>
                  ...
                  <div className="mt-5">
                    <div className="flex items-center justify-between gap-4">
                      <label
                        htmlFor={`invoice-email-body-${invoiceId}`}
                        className="block text-sm font-semibold text-slate-700"
                      >
                        Email Message
                      </label>
                    ...
                    <div className="mt-2 rounded-lg bg-slate-50 px-4 py-3 text-xs leading-5 text-slate-500">
                      ...
                      button and invoice summary are added automatically, so you cannot accidentally remove the customer link.
                    </div>
                  </div>
                  ...
                  <div className="mt-6 border-t border-slate-200 pt-6">
                    ...
                    <div className="mt-3 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
                      ...
                      <p className="mt-1 text-xs leading-5 text-blue-700">
                        The customer&apos;s secure View Invoice button is included automatically in the email.
                      </p>
                    </div>
